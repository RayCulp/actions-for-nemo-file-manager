...
| OCR PDFs using OCRmyPDF| ocr_pdf.nemo_action | OCR one or more PDFs using Tesseract and OCRmyPDF | Tesseract (https://lindevs.com/install-tesseract-ocr-on-ubuntu/), OCRmyPDF (https://ocrmypdf.readthedocs.io/en/latest/installation.html) |
